...
class AsyncToSync:
    ...
    def __call__(self, *args, **kwargs):
        ...
        # main_pages event loop's thread if it's there, otherwise make a new loop
        # in this thread.
        try:
...
class SyncToAsync:
    ...
    outermost), this will just be the main_pages thread. This is achieved by idling
    ...
    # Storage for main_pages event loop references
